 ...
 *
 * @generated SignedSource<<cbef4de8b76c06b9b83949a01bfeae24>>
 */
...
bool ReactNativeFeatureFlagsAccessor::enableCSSCalc() {
  auto flagValue = enableCSSCalc_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(15, "enableCSSCalc");

    flagValue = currentProvider_->enableCSSCalc();
    enableCSSCalc_ = flagValue;
  }
