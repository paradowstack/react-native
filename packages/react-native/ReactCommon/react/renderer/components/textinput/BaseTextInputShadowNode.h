 ...
 private:
  ...
  AttributedString getAttributedString(
    ...
    DynamicResolver resolver(
        props.calcExpressions, DynamicResolveContext{{}, layoutContext});
    resolver.resolve(fnv1a("fontSize"), textAttributes.fontSize);
    if (props.calcExpressions.contains(fnv1a("letterSpacing"))) {
      DynamicResolver resolver(
          props.calcExpressions, DynamicResolveContext{{}, layoutContext});
			textAttributes.letterSpacing = resolver.resolveNumber(fnv1a("letterSpacing"));
    }
